...
export const Mic = ({ s = 20, c = 'currentColor' }: IconProps) => (
...
export const Play = ({ s = 16, c = 'currentColor' }: IconProps) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill={c}><path d="M7 5v14l12-7z"/></svg>
);

export const Pause = ({ s = 16, c = 'currentColor' }: IconProps) => (
...
export const Check = ({ s = 16, c = 'currentColor' }: IconProps) => (
...
export const Close = ({ s = 16, c = 'currentColor' }: IconProps) => (
...
export const Back = ({ s = 18, c = 'currentColor' }: IconProps) => (
...
export const Star = ({ s = 18, c = 'currentColor', filled = false }: IconProps & { filled?: boolean }) => (
...
export const Clock = ({ s = 18, c = 'currentColor' }: IconProps) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.75" strokeLinecap="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>
);

export const Home = ({ s = 22, c = 'currentColor' }: IconProps) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
    <path d="M3 12l9-8 9 8v9a1 1 0 0 1-1 1h-5v-7h-6v7H4a1 1 0 0 1-1-1z"/>
  </svg>
);

export const Kid = ({ s = 18, c = 'currentColor' }: IconProps) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 4-7 8-7s8 3 8 7"/>
  </svg>
);

export const Sparkle = ({ s = 16, c = 'currentColor' }: IconProps) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill={c}>
    <path d="M12 2l1.8 6.2L20 10l-6.2 1.8L12 18l-1.8-6.2L4 10l6.2-1.8z"/>
  </svg>
);

export const Plus = ({ s = 18, c = 'currentColor' }: IconProps) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round"><path d="M12 5v14M5 12h14"/></svg>
);

export const Chevron = ({ s = 14, c = 'currentColor' }: IconProps) => (
...
export const ArrowRight = ({ s = 18, c = 'currentColor' }: IconProps) => (
...
export const Settings = ({ s = 20, c = 'currentColor' }: IconProps) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
export const TrendUp = ({ s = 16, c = 'currentColor' }: IconProps) => (
  <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
